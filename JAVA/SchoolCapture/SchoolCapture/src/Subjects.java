...
public class Subjects extends JPanel {
	...
	public Subjects() {
		...
		korean.setBackground(new Color(220, 220, 220));
		korean.setForeground(Color.DARK_GRAY);
		korean.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		korean.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ViewPic korean = new ViewPic(path + "\\UploadedFiles\\" + "πÆ«–", "πÆ«–");
				removeAll();
				add(korean);
				revalidate();
				repaint();
		...
		design.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic design = new ViewPic(path + "\\UploadedFiles\\" + "µ¿œ", "µ¿œ");
				removeAll();
				add(design);
				revalidate();
				repaint();
		...
		design.setBackground(new Color(220, 220, 220));
		design.setForeground(Color.DARK_GRAY);
		design.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		game.setBackground(new Color(220, 220, 220));
		game.setForeground(Color.DARK_GRAY);
		game.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		math.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic math = new ViewPic(path + "\\UploadedFiles\\" + "πÃ¿˚", "πÃ¿˚");
				removeAll();
				add(math);
				revalidate();
				repaint();
		...
		math.setBackground(new Color(220, 220, 220));
		math.setForeground(Color.DARK_GRAY);
		math.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		money.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic money = new ViewPic(path + "\\UploadedFiles\\" + "ªÛ∞Ê", "ªÛ∞Ê");
				removeAll();
				add(money);
				revalidate();
				repaint();
		...
		money.setBackground(new Color(220, 220, 220));
		money.setForeground(Color.DARK_GRAY);
		money.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		english.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic english = new ViewPic(path + "\\UploadedFiles\\" + "øµæÓ", "øµæÓ");
				removeAll();
				add(english);
				revalidate();
				repaint();
		...
		english.setBackground(new Color(220, 220, 220));
		english.setForeground(Color.DARK_GRAY);
		english.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		web1.setBackground(new Color(220, 220, 220));
		web1.setForeground(Color.DARK_GRAY);
		web1.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		web2.setBackground(new Color(220, 220, 220));
		web2.setForeground(Color.DARK_GRAY);
		web2.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		music.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic music = new ViewPic(path + "\\UploadedFiles\\" + "¿Ωæ«", "¿Ωæ«");
				removeAll();
				add(music);
				revalidate();
				repaint();
		...
		music.setBackground(new Color(220, 220, 220));
		music.setForeground(Color.DARK_GRAY);
		music.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		japan.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic japan = new ViewPic(path + "\\UploadedFiles\\" + "¿œ∫ªæÓ", "¿œ∫ªæÓ");
				removeAll();
				add(japan);
				revalidate();
				repaint();
		...
		japan.setBackground(new Color(220, 220, 220));
		japan.setForeground(Color.DARK_GRAY);
		japan.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		JAVA.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic JAVA = new ViewPic(path + "\\UploadedFiles\\" + "¿⁄πŸ", "¿⁄πŸ");
				removeAll();
				add(JAVA);
				revalidate();
				repaint();
		...
		JAVA.setBackground(new Color(220, 220, 220));
		JAVA.setForeground(Color.DARK_GRAY);
		JAVA.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		loot.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic loot = new ViewPic(path + "\\UploadedFiles\\" + "¡¯∑Œ", "¡¯∑Œ");
				removeAll();
				add(loot);
				revalidate();
				repaint();
		...
		loot.setBackground(new Color(220, 220, 220));
		loot.setForeground(Color.DARK_GRAY);
		loot.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
		...
		chemi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewPic chemi = new ViewPic(path + "\\UploadedFiles\\" + "»≠«–", "»≠«–");
				removeAll();
				add(chemi);
				revalidate();
				repaint();
		...
		chemi.setBackground(new Color(220, 220, 220));
		chemi.setForeground(Color.DARK_GRAY);
		chemi.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 20));
